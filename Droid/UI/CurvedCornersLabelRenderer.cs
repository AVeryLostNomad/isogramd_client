...
[assembly: ExportRenderer(typeof(CurvedCornersLabel), typeof(Isogramd.Droid.UI.CurvedCornersLabelRenderer))]
namespace Isogramd.Droid.UI
{
    public class CurvedCornersLabelRenderer : LabelRenderer
    {
		...
		public static float DpToPixels(Context context, float valueInDp)
		{
			...
			return TypedValue.ApplyDimension(Android.Util.ComplexUnitType.Dip, valueInDp, metrics);
		}
    }
}
