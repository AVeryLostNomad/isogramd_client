...
namespace Isogramd.Util
{
	public class ShapeView : BoxView
	{
		...
		public static readonly BindableProperty FilledProperty = BindableProperty.Create<ShapeView, Boolean>(s => s.Filled, false);
		...
		{
			get { return (Boolean)GetValue(FilledProperty); }
